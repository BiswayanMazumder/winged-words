...
export default function Navbar() {
    ...
    <img src="https://images.unsplash.com/photo-1718938610048-843cfecefef6?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Profile Picture" height={50} width={50} className='profiledp' />
    <div className="profilepicturetext">Biswayan Mazumder</div>
</div>
